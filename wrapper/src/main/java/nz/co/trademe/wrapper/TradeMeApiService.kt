...
interface TradeMeApiService {
    ...
    fun generalSearch(@QueryMap filters: Map<String, String>): Observable<SearchCollection?> = TODO("Change the return type of this method so you can retrieve a SearchCollection")
    ...
    fun getCategory(@Path("number") number: String): Observable<Category?> = TODO("Change the return type of this method so you can retrieve a Category")
    ...
    fun getListing(@Path("listingId") listingId: Long,
                   @Query("depth") depth: Int): Observable<ListedItemDetail?> = TODO("Change the return type of this method so you can retrieve a ListedItemDetail")
}